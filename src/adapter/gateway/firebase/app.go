...
func InitializeApp() *firebase.App {
	if config.Mode == "debug" && config.Environment == "dev" {
		opt := option.WithCredentialsJSON([]byte(`{
			...
			"client_email": "harvest-firebase-admin@flyvase-dev.iam.gserviceaccount.com",
			"client_id": "107543502615991839732",
			"auth_uri": "https://accounts.google.com/o/oauth2/auth",
			"token_uri": "https://oauth2.googleapis.com/token",
			"auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
			"client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/harvest-firebase-admin%40flyvase-dev.iam.gserviceaccount.com"
		}`))
